...
extern char __tls_data_start[], __tls_bss_start[], __tls_bss_end[];
...
__libc_setup_tls (void)
{
  ...
  memsz = __tls_bss_end - __tls_data_start;
  filesz = __tls_bss_start - __tls_data_start;
  initimage = (void *) __tls_data_start;
  align = 0x200000;
  max_align = 0x200000;
