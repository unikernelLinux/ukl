/**
 * Test program to ensure that UKL can run a multi-threaded application.
 * Creates 100 threads (and joins them after they complete)
 * Prints a string after all threads are joined to indicate success
*/
#include <sched.h>
#include <time.h>
#include <unistd.h>
