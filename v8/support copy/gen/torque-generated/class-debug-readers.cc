...
std::vector<std::unique_ptr<ObjectProperty>> TqJSWrappedFunction::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("wrapped_target_function", "v8::internal::TaggedValue", "v8::internal::JSReceiver", GetWrappedTargetFunctionAddress(), 1, 4, std::move(wrapped_target_function_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedValue", "v8::internal::NativeContext", GetContextAddress(), 1, 4, std::move(context_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSFunction::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("code", "v8::internal::TaggedValue", "v8::internal::CodeDataContainer", GetCodeAddress(), 1, 4, std::move(code_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmInternalFunction::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("ref", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetRefAddress(), 1, 4, std::move(ref_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> external_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("external", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetExternalAddress(), 1, 4, std::move(external_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> code_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("code", "v8::internal::TaggedValue", "v8::internal::CodeDataContainer", GetCodeAddress(), 1, 4, std::move(code_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqDataHandler::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("data1", "v8::internal::TaggedValue", "v8::internal::Object", GetData1Address(), 1, 4, std::move(data1_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> data2_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("data2", "v8::internal::TaggedValue", "v8::internal::Object", GetData2Address(), 1, 4, std::move(data2_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> data3_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("data3", "v8::internal::TaggedValue", "v8::internal::Object", GetData3Address(), 1, 4, std::move(data3_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScopeInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("class_scope_has_private_brand", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_saved_class_variable", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 11));
...
std::vector<std::unique_ptr<ObjectProperty>> TqStackFrameInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("shared_or_script", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetSharedOrScriptAddress(), 1, 4, std::move(shared_or_script_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> function_name_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("function_name", "v8::internal::TaggedValue", "v8::internal::String", GetFunctionNameAddress(), 1, 4, std::move(function_name_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_constructor", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("bytecode_offset_or_source_position", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 30, 2));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqErrorStackData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("call_site_infos_or_formatted_stack", "v8::internal::TaggedValue", "v8::internal::Object", GetCallSiteInfosOrFormattedStackAddress(), 1, 4, std::move(call_site_infos_or_formatted_stack_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> limit_or_stack_frame_infos_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("limit_or_stack_frame_infos", "v8::internal::TaggedValue", "v8::internal::Object", GetLimitOrStackFrameInfosAddress(), 1, 4, std::move(limit_or_stack_frame_infos_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPromiseOnStack::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqStruct::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> prev_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("prev", "v8::internal::TaggedValue", "v8::internal::Object", GetPrevAddress(), 1, 4, std::move(prev_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> promise_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("promise", "v8::internal::TaggedValue", "v8::internal::Object", GetPromiseAddress(), 1, 4, std::move(promise_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalCalendar::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("calendar_index", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 1));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalDuration::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("years", "v8::internal::TaggedValue", "v8::internal::Object", GetYearsAddress(), 1, 4, std::move(years_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> months_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("months", "v8::internal::TaggedValue", "v8::internal::Object", GetMonthsAddress(), 1, 4, std::move(months_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> weeks_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("weeks", "v8::internal::TaggedValue", "v8::internal::Object", GetWeeksAddress(), 1, 4, std::move(weeks_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> days_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("days", "v8::internal::TaggedValue", "v8::internal::Object", GetDaysAddress(), 1, 4, std::move(days_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> hours_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("hours", "v8::internal::TaggedValue", "v8::internal::Object", GetHoursAddress(), 1, 4, std::move(hours_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> minutes_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("minutes", "v8::internal::TaggedValue", "v8::internal::Object", GetMinutesAddress(), 1, 4, std::move(minutes_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> seconds_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("seconds", "v8::internal::TaggedValue", "v8::internal::Object", GetSecondsAddress(), 1, 4, std::move(seconds_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> milliseconds_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("milliseconds", "v8::internal::TaggedValue", "v8::internal::Object", GetMillisecondsAddress(), 1, 4, std::move(milliseconds_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> microseconds_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("microseconds", "v8::internal::TaggedValue", "v8::internal::Object", GetMicrosecondsAddress(), 1, 4, std::move(microseconds_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> nanoseconds_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("nanoseconds", "v8::internal::TaggedValue", "v8::internal::Object", GetNanosecondsAddress(), 1, 4, std::move(nanoseconds_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalInstant::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> nanoseconds_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("nanoseconds", "v8::internal::TaggedValue", "v8::internal::BigInt", GetNanosecondsAddress(), 1, 4, std::move(nanoseconds_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalPlainDateTime::GetProperties(d::MemoryAccessor accessor) const {
  ...
  year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_year", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 20, 1));
  year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_month", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 4, 21));
  year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_day", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 25));
  result.push_back(std::make_unique<ObjectProperty>("year_month_day", "v8::internal::TaggedValue", "v8::internal::Object", GetYearMonthDayAddress(), 1, 4, std::move(year_month_day_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> hour_minute_second_struct_field_list;
  hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_hour", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 1));
  hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_minute", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 6, 6));
  hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_second", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 6, 12));
  result.push_back(std::make_unique<ObjectProperty>("hour_minute_second", "v8::internal::TaggedValue", "v8::internal::Object", GetHourMinuteSecondAddress(), 1, 4, std::move(hour_minute_second_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> second_parts_struct_field_list;
  second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_millisecond", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 1));
  second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_microsecond", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 11));
  second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_nanosecond", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 21));
  result.push_back(std::make_unique<ObjectProperty>("second_parts", "v8::internal::TaggedValue", "v8::internal::Object", GetSecondPartsAddress(), 1, 4, std::move(second_parts_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> calendar_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("calendar", "v8::internal::TaggedValue", "v8::internal::JSReceiver", GetCalendarAddress(), 1, 4, std::move(calendar_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalTimeZone::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_offset", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("offset_milliseconds_or_time_zone_index", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 28, 2));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> details_struct_field_list;
  details_struct_field_list.push_back(std::make_unique<StructProperty>("offset_sub_milliseconds", CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 21, 1));
  result.push_back(std::make_unique<ObjectProperty>("details", "v8::internal::TaggedValue", "v8::internal::Object", GetDetailsAddress(), 1, 4, std::move(details_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalZonedDateTime::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("time_zone", "v8::internal::TaggedValue", "v8::internal::JSReceiver", GetTimeZoneAddress(), 1, 4, std::move(time_zone_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> calendar_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("calendar", "v8::internal::TaggedValue", "v8::internal::JSReceiver", GetCalendarAddress(), 1, 4, std::move(calendar_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScriptOrModule::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("resource_name", "v8::internal::TaggedValue", "v8::internal::Object", GetResourceNameAddress(), 1, 4, std::move(resource_name_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqInterpreterData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("interpreter_trampoline", "v8::internal::TaggedValue", "v8::internal::CodeDataContainer", GetInterpreterTrampolineAddress(), 1, 4, std::move(interpreter_trampoline_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanUnionType::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("type1", "v8::internal::TaggedValue", "v8::internal::TurbofanType", GetType1Address(), 1, 4, std::move(type1_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> type2_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("type2", "v8::internal::TaggedValue", "v8::internal::TurbofanType", GetType2Address(), 1, 4, std::move(type2_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanHeapConstantType::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("constant", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetConstantAddress(), 1, 4, std::move(constant_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSV8BreakIterator::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("locale", "v8::internal::TaggedValue", "v8::internal::String", GetLocaleAddress(), 1, 4, std::move(locale_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> break_iterator_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("break_iterator", "v8::internal::TaggedValue", "v8::internal::Foreign", GetBreakIteratorAddress(), 1, 4, std::move(break_iterator_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> unicode_string_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("unicode_string", "v8::internal::TaggedValue", "v8::internal::Foreign", GetUnicodeStringAddress(), 1, 4, std::move(unicode_string_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_adopt_text_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_adopt_text", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundAdoptTextAddress(), 1, 4, std::move(bound_adopt_text_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_first_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_first", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundFirstAddress(), 1, 4, std::move(bound_first_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_next_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_next", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundNextAddress(), 1, 4, std::move(bound_next_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_current_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_current", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundCurrentAddress(), 1, 4, std::move(bound_current_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_break_type_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_break_type", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundBreakTypeAddress(), 1, 4, std::move(bound_break_type_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSCollator::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_collator", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuCollatorAddress(), 1, 4, std::move(icu_collator_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_compare_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_compare", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundCompareAddress(), 1, 4, std::move(bound_compare_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> locale_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("locale", "v8::internal::TaggedValue", "v8::internal::String", GetLocaleAddress(), 1, 4, std::move(locale_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDateTimeFormat::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_locale", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuLocaleAddress(), 1, 4, std::move(icu_locale_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_simple_date_format_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_simple_date_format", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuSimpleDateFormatAddress(), 1, 4, std::move(icu_simple_date_format_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_date_interval_format_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_date_interval_format", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuDateIntervalFormatAddress(), 1, 4, std::move(icu_date_interval_format_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_format_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_format", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundFormatAddress(), 1, 4, std::move(bound_format_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDisplayNames::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("internal", "v8::internal::TaggedValue", "v8::internal::Foreign", GetInternalAddress(), 1, 4, std::move(internal_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSListFormat::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuFormatterAddress(), 1, 4, std::move(icu_formatter_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("style", CheckTypeName<JSListFormat::Style /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSListFormat::Style"), CheckTypeName<JSListFormat::Style /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSListFormat::Style"), 0, 2, 1));
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("Type", CheckTypeName<JSListFormat::Type /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSListFormat::Type"), CheckTypeName<JSListFormat::Type /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSListFormat::Type"), 0, 2, 3));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqJSNumberFormat::GetIcuNumberRangeFormatterAddress() const {
  return address_ - i::kHeapObjectTag + 20;
}

Value<uintptr_t> TqJSNumberFormat::GetIcuNumberRangeFormatterValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetIcuNumberRangeFormatterAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSNumberFormat::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_number_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuNumberFormatterAddress(), 1, 4, std::move(icu_number_formatter_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_number_range_formatter_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_number_range_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuNumberRangeFormatterAddress(), 1, 4, std::move(icu_number_range_formatter_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> bound_format_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("bound_format", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetBoundFormatAddress(), 1, 4, std::move(bound_format_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
uintptr_t TqJSPluralRules::GetIcuNumberRangeFormatterAddress() const {
  return address_ - i::kHeapObjectTag + 28;
}

Value<uintptr_t> TqJSPluralRules::GetIcuNumberRangeFormatterValue(d::MemoryAccessor accessor) const {
  i::Tagged_t value{};
  d::MemoryAccessResult validity = accessor(GetIcuNumberRangeFormatterAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
  return {validity, EnsureDecompressed(value, address_)};
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSPluralRules::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_plural_rules", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuPluralRulesAddress(), 1, 4, std::move(icu_plural_rules_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_number_formatter_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_number_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuNumberFormatterAddress(), 1, 4, std::move(icu_number_formatter_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_number_range_formatter_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_number_range_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuNumberRangeFormatterAddress(), 1, 4, std::move(icu_number_range_formatter_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRelativeTimeFormat::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("numberingSystem", "v8::internal::TaggedValue", "v8::internal::String", GetNumberingSystemAddress(), 1, 4, std::move(numberingSystem_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> icu_formatter_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("icu_formatter", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuFormatterAddress(), 1, 4, std::move(icu_formatter_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
  flags_struct_field_list.push_back(std::make_unique<StructProperty>("numeric", CheckTypeName<JSRelativeTimeFormat::Numeric /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSRelativeTimeFormat::Numeric"), CheckTypeName<JSRelativeTimeFormat::Numeric /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("JSRelativeTimeFormat::Numeric"), 0, 1, 1));
  result.push_back(std::make_unique<ObjectProperty>("flags", "v8::internal::TaggedValue", "v8::internal::Object", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSegmentIterator::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("icu_break_iterator", "v8::internal::TaggedValue", "v8::internal::Foreign", GetIcuBreakIteratorAddress(), 1, 4, std::move(icu_break_iterator_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> unicode_string_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("unicode_string", "v8::internal::TaggedValue", "v8::internal::Foreign", GetUnicodeStringAddress(), 1, 4, std::move(unicode_string_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmApiFunctionRef::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("native_context", "v8::internal::TaggedValue", "v8::internal::NativeContext", GetNativeContextAddress(), 1, 4, std::move(native_context_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> callable_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("callable", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetCallableAddress(), 1, 4, std::move(callable_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> suspender_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("suspender", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetSuspenderAddress(), 1, 4, std::move(suspender_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmFunctionData::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> internal_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("internal", "v8::internal::TaggedValue", "v8::internal::WasmInternalFunction", GetInternalAddress(), 1, 4, std::move(internal_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wrapper_code_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wrapper_code", "v8::internal::TaggedValue", "v8::internal::CodeDataContainer", GetWrapperCodeAddress(), 1, 4, std::move(wrapper_code_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmExportedFunctionData::GetProperties(d::MemoryAccessor accessor) const {
  ...
  std::vector<std::unique_ptr<StructProperty>> signature_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("signature", "v8::internal::TaggedValue", "v8::internal::Foreign", GetSignatureAddress(), 1, 4, std::move(signature_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> wrapper_budget_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("wrapper_budget", "v8::internal::TaggedValue", "v8::internal::Object", GetWrapperBudgetAddress(), 1, 4, std::move(wrapper_budget_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> c_wrapper_code_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("c_wrapper_code", "v8::internal::TaggedValue", "v8::internal::CodeDataContainer", GetCWrapperCodeAddress(), 1, 4, std::move(c_wrapper_code_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmOnFulfilledData::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> suspender_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("suspender", "v8::internal::TaggedValue", "v8::internal::WasmSuspenderObject", GetSuspenderAddress(), 1, 4, std::move(suspender_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmContinuationObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("stack", "v8::internal::TaggedValue", "v8::internal::Foreign", GetStackAddress(), 1, 4, std::move(stack_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> jmpbuf_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("jmpbuf", "v8::internal::TaggedValue", "v8::internal::Foreign", GetJmpbufAddress(), 1, 4, std::move(jmpbuf_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("parent", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetParentAddress(), 1, 4, std::move(parent_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmSuspenderObject::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> continuation_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("continuation", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetContinuationAddress(), 1, 4, std::move(continuation_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("parent", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetParentAddress(), 1, 4, std::move(parent_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> resume_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("resume", "v8::internal::TaggedValue", "v8::internal::JSObject", GetResumeAddress(), 1, 4, std::move(resume_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> state_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("state", "v8::internal::TaggedValue", "v8::internal::Object", GetStateAddress(), 1, 4, std::move(state_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTableObject::GetProperties(d::MemoryAccessor accessor) const {
  std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
  std::vector<std::unique_ptr<StructProperty>> instance_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("instance", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetInstanceAddress(), 1, 4, std::move(instance_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> entries_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTagObject::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("serialized_signature", "v8::internal::TaggedValue", "v8::internal::ByteArray", GetSerializedSignatureAddress(), 1, 4, std::move(serialized_signature_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> tag_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("tag", "v8::internal::TaggedValue", "v8::internal::HeapObject", GetTagAddress(), 1, 4, std::move(tag_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTypeInfo::GetProperties(d::MemoryAccessor accessor) const {
  ...
  result.push_back(std::make_unique<ObjectProperty>("supertypes", "v8::internal::TaggedValue", "v8::internal::FixedArray", GetSupertypesAddress(), 1, 4, std::move(supertypes_struct_field_list), d::PropertyKind::kSingle));
  ...
  result.push_back(std::make_unique<ObjectProperty>("instance_size", "v8::internal::TaggedValue", "v8::internal::Object", GetInstanceSizeAddress(), 1, 4, std::move(instance_size_struct_field_list), d::PropertyKind::kSingle));
  std::vector<std::unique_ptr<StructProperty>> instance_struct_field_list;
  result.push_back(std::make_unique<ObjectProperty>("instance", "v8::internal::TaggedValue", "v8::internal::WasmInstanceObject", GetInstanceAddress(), 1, 4, std::move(instance_struct_field_list), d::PropertyKind::kSingle));
  return result;
}
